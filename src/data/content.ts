...
export const siteContent = {
  ...
  hero: {
    ...
    cta: { primary: "Comenzar mi práctica", secondary: "Explorar programas" },
  },
  ...
  philosophy: {
    ...
    pillars: [
      { icon: "Flower2", title: "Cuerpo", description: "Movimiento con intención: posturas y respiración para anclarte en lo físico sin perder la ternura." },
      { icon: "Lightbulb", title: "Mente", description: "Lógica aplicada a lo emocional: observar patrones y tomar decisiones con más claridad interna." },
      { icon: "MoonStar", title: "Espíritu", description: "Un espacio para recordar quién eres más allá de tus responsabilidades y volver a ti." },
    ],
  },
  ...
  programs: {
    ...
    items: [
      { id: "encuentra-tu-centro", title: "Encuentra tu Centro", duration: "4 meses", description: "Conecta con el ahora y descubre tu autenticidad", stages: ["Conectar con el ahora", "Autoreconocimiento", "Anclar patrones y necesidades", "Avanzar con Intención"], accent: "lavender" },
      { id: "enraiza-te", title: "Enraíza-Te", duration: "4 meses", description: "Fortalece tu base y desarrolla liderazgo interior", stages: ["Volver al cuerpo", "Estabilidad emocional", "Fuerza y liderazgo interior", "Integración y expansión"], accent: "gold" },
      { id: "elogio-a-ti", title: "Elogio a Ti", duration: "4 meses", description: "Reconecta con tu esencia y activa tu poder personal", stages: ["Despertar", "Reconexión", "Reprogramación", "Consagración"], accent: "lavender" },
    ],
  },
    ...
    products: [
      {
        ...
        badge: "Gratis" as string | null,
        isFree: true,
        price: null as string | null,
        image: "/productos/guia-gratis.jpeg" as string,
        ...
        includes: ["Más de 15 posturas explicadas paso a paso", "Instrucciones de alineación seguras para principiantes", "Intención energética de cada postura", "Diseño visual limpio e imprimible"],
      ...
      },
      {
        ...
        isFree: false,
        price: "$8",
        image: "/productos/camino-merecimiento.jpeg" as string,
        payhipProductUrl: "https://payhip.com/ConLogicayAlma",
        ...
        includes: ["Ejercicios de journaling estructurados", "Preguntas de autoindagación profunda", "Afirmaciones para reprogramar el merecimiento", "Diseño editable en formato digital", "Acceso inmediato tras la compra"],
      ...
      },
      {
        ...
        isFree: false,
        price: "$4.99",
        image: "/productos/mandalas.jpeg" as string,
        payhipProductUrl: "https://payhip.com/ConLogicayAlma",
        ...
        includes: ["Mandalas originales de alta resolución", "Afirmación de abundancia por página", "Reflexión guiada para cada mandala", "Formato imprimible A4/Carta", "Acceso inmediato tras la compra"],
      ...
      },
      {
        ...
        isFree: false,
        price: "$4.99",
        image: "/productos/abundancia.jpeg" as string,
        payhipProductUrl: "https://payhip.com/ConLogicayAlma",
        ...
        includes: ["Ejercicios diarios de apertura a la abundancia", "Reflexiones sobre el dar y el recibir", "Scripting guiado para manifestar con claridad", "Rituales simples de gratitud y recepción", "Acceso inmediato tras la compra"],
  ...
  membership: {
    ...
    plans: [
      { id: "mensual", name: "Mensual", price: "Consultar en Payhip", highlight: false, features: ["Acceso al contenido del mes", "Cartas para habitarte", "Comunidad de apoyo", "Cancelás cuando quieras"] },
      { id: "anual", name: "Anual", price: "2 meses de regalo vs. pagar mes a mes", highlight: true, features: ["Todo lo del plan mensual", "Mejor precio por mes", "Prioridad en novedades", "Compromiso con tu proceso"] },
    ],
