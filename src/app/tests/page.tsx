...
export default function TestsPage() {
  ...
  return (
    ...
    >
      ...
      >
        <FlaskConical size={14} style={{ color: "var(--gold-deep)" }} aria-hidden />
        <span className="text-sm font-semibold" style={{ color: "var(--gold-deep)" }}>
          Próximamente
        </span>
      </div>
      <h1 className="title text-4xl md:text-5xl mb-4" style={{ color: "var(--accent)" }}>
        {testsPage.title}
      </h1>
      ...
      <Link
        ...
        style={{ border: "1.5px solid var(--gold-deep)", color: "var(--gold-deep)" }}
      >
        ← Volver
      </Link>
    </main>
